...
<h1 class="title"> Device Type List </h1>
<div class="table-wrap">
  <div class="table-header">
    ...
    <div class="button-wrapper">
      <Button type="button" class="filled__green" label="Add New Device Type" @click="modalToggle" />
    </div>
  </div>
  <EasyDataTable
  table-class-name="customize-table"
  :headers="header"
  :items="deviceTypeStore.deviceTypes"
  theme-color="#1363df"        
  search-field="name"
...
<script setup>
import NewTypeModal from '@/components/modal/NewTypeModal.vue'
import EditTypeModal from '@/components/modal/EditTypeModal.vue'
import DeleteTypeModal from '@/components/modal/DeleteTypeModal.vue'
...
import { useDeviceTypeStore } from '@/stores/DeviceTypeStore'
  ...
  const header = [
    ...
    { text: "Field", value: "field", sortable: true },
  ...
  onMounted( async () => {
    ...
    console.log(deviceTypeStore.deviceTypes)
  })
